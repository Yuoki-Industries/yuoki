data:extend({
...

	{
		...
		chargable_graphics = {
			picture = {
				filename = "__Yuoki__/graphics/gfx/accu_b_idle.png",
				priority = "extra-high",
				width = 256,
				height = 256,
				shift = { 0.375, -0.375 },
	...
	-- tier 1.5
	{
		...
		chargable_graphics = {
			picture = {
				filename = "__Yuoki__/graphics/gfx/accflywheel_idle.png",
				priority = "extra-high",
				width = 320,
				height = 320,
				scale = 0.5,
			...
			charge_animation = {
				filename = "__Yuoki__/graphics/gfx/accflywheel_load_sheet.png",
				width = 320,
				height = 320,
				scale = 0.5,
				frame_count = 2,
			...
			discharge_animation = {
				filename = "__Yuoki__/graphics/gfx/accflywheel_unload_sheet.png",
				width = 320,
				height = 320,
				scale = 0.5,
				frame_count = 2,
...

	{
		...
		chargable_graphics = {
			picture = {
				filename = "__Yuoki__/graphics/gfx/aqe-idle.png",
				priority = "extra-high",
				width = 384,
				height = 384,
				scale = 0.5,
			...
			charge_animation = {
				filename = "__Yuoki__/graphics/gfx/aqe-charge.png",
				width = 384,
				height = 384,
				scale = 0.5,
				shift = { 1.0, -1.0 },
			...
			charge_light = { intensity = 0.3, size = 15 },
			discharge_animation = {
				filename = "__Yuoki__/graphics/gfx/aqe-discharge.png",
				width = 384,
				height = 384,
				scale = 0.5,
				shift = { 1.0, -1.0 },
...

	{
		...
		energy_source = {
			...
			output_flow_limit = "7500kW",
		},

		chargable_graphics = {
			picture = {
				filename = "__Yuoki__/graphics/gfx/accu_crystal_idle.png",
				priority = "extra-high",
				width = 384,
				height = 384,
				scale = 0.5,
			...
			charge_animation = {
				filename = "__Yuoki__/graphics/gfx/accu_crystal_charge.png",
				width = 384,
				height = 384,
				scale = 0.5,
				shift = { 1.0, -1.0 },
			...
			discharge_animation = {
				filename = "__Yuoki__/graphics/gfx/accu_crystal_discharge.png",
				width = 384,
				height = 384,
				scale = 0.5,
				shift = { 1.0, -1.0 },
