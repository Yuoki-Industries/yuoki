...
-- if space age
require("prototypes.integration.space-age.technology") 			-- Integraton - Space Age - Technology

-- Make smart inserter into a stack inserter
require("prototypes.integration.space-age.inserter")			-- Integraton - Space Age - Inserters

require("prototypes.integration.bobores._all") 					-- Integraton - Bob's Ores
require("prototypes.integration.angels._all") 					-- Integraton - Angel's
